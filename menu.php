...
<nav style='background-color: grey; padding: 10px;'>
  <ul style='display:flex; flex-direction:row; justify-content:center; gap:15px; list-style: none; margin: 0; padding: 0;'>
    <li>
      <a href='http://localhost/bank_php/read.php' style='text-decoration: none; color: white; font-weight: bold; padding: 5px 10px; border-radius: 5px; background-color: #333;'>
        Saskaitu sarasas
      </a>
    </li>
    <li>
